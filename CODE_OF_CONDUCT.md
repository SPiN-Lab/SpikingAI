...
[Code of Conduct Enforcement Team](https://SpikingAI.readthedocs.io/en/stable/governance.html#leadership):
...
necessary for the safety of the `SpikingAI` community, including but not
limited to:
...
* asking a contributor to no longer participate in the development of `SpikingAI`

For more details on the enforcement process, please see our documentation
on [governance](https://SpikingAI.readthedocs.io/en/stable/governance.html).
